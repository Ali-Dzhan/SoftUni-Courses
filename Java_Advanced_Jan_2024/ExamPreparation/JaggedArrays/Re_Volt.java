...
public class Re_Volt {
    public static void main(String[] args) {
        ...
        while (linesCount-- > 0 && !playerWon) {
            ...
            switch (command) {
                case "up" -> playerWon = movePlayer(position, matrix, -1, 0);
                case "down" -> playerWon = movePlayer(position, matrix, +1, 0);
                case "left" -> playerWon = movePlayer(position, matrix, 0, -1);
                case "right" -> playerWon = movePlayer(position, matrix, 0, +1);
            }
        }
